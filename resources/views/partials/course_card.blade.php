...
<div
            ...
            <div class="flex justify-center space-x-4">
                ...
                <form action="{{ route('learning.add') }}" method="POST">
                    ...
                    <button type="submit" title="Add to My Learning"
                        class="text-4xl text-green-500 hover:text-green-700">
    ...
    <div class="p-5">
        ...
        <p class="text-red-500 text-sm my-2">Course starts on {{ \Carbon\Carbon::parse($course->start_date)->format('F
            j, Y')
            }}</p>
        @else
        <p class="text-green-500 text-sm my-2">Available now!</p>
        @endif
        <p class="text-sm text-gray-500 text-end">{{ $course->reviews->count() }} Reviews</p>
    </div>
</div>